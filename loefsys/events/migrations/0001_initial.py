    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_registration_message', models.CharField(blank=True, default='No registration required', help_text='Default: No registration required', max_length=200, verbose_name='message when there is no registration')),
